class Circuit
{
	...
	*/
	create(){
		...
		for (var n=0; n<this.rumble_segments; n++){
			this.segments[n].color.road = '0x888888';							// start
			this.segments[this.segments.length-1-n].color.road = '0x888888';	// finish
	...
	*/
	createSegment(){
		// console.log(this.texture.drawGameObject);
		// define colors
		const COLORS = {
			LIGHT:	{road: '0x888888', grass: '0xEA922D', rumble: '0x000000'},
			DARK:	{road: '0x888888', grass: '0xCA6B1C', rumble: '0xDDDDDD', lane: '0xFFFFFF'},
			IMG: 	{img: this.graphics.scene.add.sprite(100, 100, "cow")}
		};
		console.log(this.graphics.scene.add.sprite);
		...
		this.segments.push({
			...
			point: {
				...
				screen:	{x: 0, y: 0, w: 0},
				// Image:<img src="../assets/E0.png" alt="" />,
				scale: -1,
			},
	...
	*/	
	drawPolygon(x1, y1, x2, y2, x3, y3, x4, y4, color){
		// console.log(this.texture.drawGameObject);
		// console.log(this.texture.drawGameObject.animate);
